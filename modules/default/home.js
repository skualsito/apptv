const socket = io('http://192.168.1.106:8080');
...
socket.on("web-cliente", function(data){
    ...
    switch (data) {
      case "youtube":
        $(".container-general").load("./modules/default/youtube/youtube.html", function(){
      ...
      break;
      case "netflix":
        $(".container-general").load("./modules/default/netflix/netflix.html", function(){
